...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Clean API call - RedwoodSDK handles CORS automatically
      ...
      // RedwoodSDK handles session management automatically
      localStorage.setItem('token', data.token);
      
      // RedwoodSDK provides navigation helpers
...
- Manual token handling throughout app
- CORS configuration needed
- Manual error handling

RedwoodSDK Version:
- Simple form component
- Framework handles auth complexity
- Automatic CORS handling
- Clean error handling
- 'use client' directive for selective interactivity
